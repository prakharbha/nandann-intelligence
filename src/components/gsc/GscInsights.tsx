...
import type { GscInsight } from '@/lib/gscReportData'
...
export function GscInsights({ insights, recommendations, summary }: Props) {
    return (
                        ...
                        return (
                            <div key={i} className={`rounded-2xl p-5 border ${c.bg} ${c.border}`}>
                                <div className="flex items-start gap-3">
                                    <div className={`w-8 h-8 rounded-xl flex items-center justify-center flex-shrink-0 ${c.bg} border ${c.border}`}>
